...
import (
	...
	"github.com/idmaksim/expense-tracker-cli/internal/delivery/cli/commands"
	"github.com/idmaksim/expense-tracker-cli/internal/delivery/cli/handlers"
	"github.com/idmaksim/expense-tracker-cli/internal/infrastructure/storage"
...
func main() {
	...
	dataDir := filepath.Join(homeDir, ".expense-tracker")
	...
	service := services.NewExpenseService(store)
